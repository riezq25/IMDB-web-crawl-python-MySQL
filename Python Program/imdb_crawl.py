...
def insertIMDB(type, id_item, nama_item, link_item, dob, pob, dod, pod, bn, height, biodata, poster):
    try:

        sql = ""
        if(type == "aktor"):
            sql = "INSERT INTO `imdb_cast` (`id_cast`, `nama_cast`, `dob_cast`, `pob_cast`, `dod_cast`, `pod_cast`, `birth_name_cast`, `height_cast`, `bio_cast`, `poster_cast`, `link_cast`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
        elif(type == "sutradara"):
            sql = "INSERT INTO `imdb_director` (`id_director`, `nama_director`, `dob_director`, `pob_director`, `dod_director`, `pod_director`, `birth_name_director`, `height_director`, `bio_director`, `poster_director`, `link_director`) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)"
